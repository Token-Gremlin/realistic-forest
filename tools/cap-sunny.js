// Default fair-weather grove: prove high sun, no rain, readable plants.
...
f.pipeline.settings.exposure = 1.45;
...
f.camera.lookAt(x - 5.5, gh + 1.35, z + 9.0);
...
return {
  ...
  cover: +f.weather.state.cover.toFixed(2),
