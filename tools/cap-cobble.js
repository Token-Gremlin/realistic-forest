// high-sun wet cobble at the waterline. Same mist-run corridor as the
// foam still, but keep rocks and look at a lip stone. No caustic hold.
...
function place(bank, look, pull, rise, side = 0) {
  ...
  f.camera.lookAt(look.x, lookH + lookW * 0.08 + 0.72, look.z);
