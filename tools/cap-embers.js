// blue hour: held ember sparks after AgX. World additive HDR dies in the grade.
// Same open fire pad as the smoke plate — do not hunt a new grove.
...
return {
  ...
  holdSmoke: !!f.forest.fire.holdSmoke,
  holdEmbers: !!f.forest.fire.holdEmbers,
  emberW: +(f.pipeline.compositePass?.material?.uniforms?.uEmberHold?.value?.w ?? -1).toFixed(2),
