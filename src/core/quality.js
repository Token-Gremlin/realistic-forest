...
export const PRESETS = {
  ...
  tiny: {
    ...
    volumetricSteps: 8,
    grassDensity: 0.12, grassRings: 2, grassRadius: 14,
    treeDensity: 0.3, treeRadius: 110, treeDetail: 0,
    clutterDensity: 0.15, clutterRadius: 18,
    rainParticles: 6000,
  ...
  low: {
    ...
    volumetricSteps: 20,
    grassDensity: 0.35, grassRings: 3, grassRadius: 26,
    treeDensity: 0.55, treeRadius: 190, treeDetail: 0,
    clutterDensity: 0.35, clutterRadius: 34,
    rainParticles: 24000,
    ao: true, dof: true, taa: true, volumetrics: true,
  },
  medium: {
    ...
    volumetricSteps: 28,
    grassDensity: 0.7, grassRings: 4, grassRadius: 38,
    treeDensity: 0.8, treeRadius: 250, treeDetail: 1,
    clutterDensity: 0.7, clutterRadius: 48,
    rainParticles: 48000,
    ao: true, dof: true, taa: true, volumetrics: true,
  },
  high: {
    ...
    volumetricSteps: 36,
    grassDensity: 1.0, grassRings: 5, grassRadius: 52,
  ...
  ultra: {
    ...
    volumetricSteps: 48,
    grassDensity: 1.45, grassRings: 6, grassRadius: 64,
    treeDensity: 1.15, treeRadius: 340, treeDetail: 2,
    clutterDensity: 1.4, clutterRadius: 76,
