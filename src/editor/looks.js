...
export const LOOKS = {
  bosque: {
    ...
    trees: 0.94, treeRadius: 310, grass: 1.30, grassHeight: 1.00, clutter: 1.14,
    ferns: 1.00, flowers: 1.00, mushrooms: 1.00, sedges: 1.00, lilies: 1.00,
    moss: 1.10, logs: 1.00, rocks: 1.00,
    water: 0.85, ponds: 1.00, valley: 14.5, waterRadius: 180,
  ...
  prado: {
    ...
    trees: 0.28, treeRadius: 280, grass: 1.85, grassHeight: 1.18, clutter: 1.08,
    ferns: 0.30, flowers: 1.90, mushrooms: 0.35, sedges: 0.70, lilies: 0.35,
    moss: 0.45, logs: 0.30, rocks: 0.65,
    water: 0.42, ponds: 0.50, valley: 11.0, waterRadius: 120,
  ...
  brejo: {
    ...
    trees: 0.48, treeRadius: 300, grass: 0.82, grassHeight: 1.22, clutter: 1.22,
    ferns: 1.20, flowers: 0.70, mushrooms: 0.80, sedges: 2.15, lilies: 2.20,
    moss: 1.45, logs: 0.85, rocks: 0.50,
    water: 1.65, ponds: 1.85, valley: 18.5, waterRadius: 200,
  ...
  mata: {
    ...
    trees: 1.55, treeRadius: 320, grass: 0.40, grassHeight: 0.82, clutter: 1.38,
    ferns: 1.90, flowers: 0.32, mushrooms: 1.70, sedges: 0.50, lilies: 0.18,
    moss: 1.85, logs: 1.50, rocks: 0.80,
    water: 0.68, ponds: 0.70, valley: 13.0, waterRadius: 130,
  ...
  clareira: {
    ...
    trees: 0.52, treeRadius: 300, grass: 1.48, grassHeight: 1.06, clutter: 1.12,
    ferns: 0.70, flowers: 1.60, mushrooms: 0.70, sedges: 0.80, lilies: 0.60,
    moss: 0.85, logs: 0.70, rocks: 0.90,
    water: 0.78, ponds: 0.95, valley: 14.0, waterRadius: 140,
  ...
  cinema: {
    ...
    trees: 1.05, treeRadius: 310, grass: 1.16, grassHeight: 1.00, clutter: 1.22,
    ferns: 1.20, flowers: 0.90, mushrooms: 1.10, sedges: 1.00, lilies: 0.80,
    moss: 1.28, logs: 1.22, rocks: 1.00,
    water: 0.92, ponds: 1.10, valley: 15.0, waterRadius: 150,
  ...
  rochoso: {
    ...
    trees: 0.32, treeRadius: 280, grass: 0.46, grassHeight: 0.68, clutter: 0.92,
    ferns: 0.22, flowers: 0.28, mushrooms: 0.22, sedges: 0.18, lilies: 0.08,
    moss: 0.42, logs: 0.38, rocks: 2.20,
    water: 0.26, ponds: 0.22, valley: 10.0, waterRadius: 100,
...
export const GFX_PRESETS = {
  ...
  pretty: {
    ...
    maxLod0: 48, maxLod1: 190, maxTrees: 1100, maxCards: 3000, maxClutter: 2600,
  },
  max: {
    label: 'Maximum',
    scale: 0.98, vol: 20, ao: true,
    pxFull: 56, pxMid: 18, pxCard: 16,
    maxLod0: 68, maxLod1: 240, maxTrees: 1300, maxCards: 3400, maxClutter: 3200,
  },
};
