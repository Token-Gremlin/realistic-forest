...
export const LOOKS = {
  bosque: {
    ...
    trees: 0.94, treeRadius: 72, grass: 1.30, grassHeight: 1.00, clutter: 1.14,
  ...
  prado: {
    ...
    trees: 0.28, treeRadius: 56, grass: 1.85, grassHeight: 1.18, clutter: 1.08,
  ...
  brejo: {
    ...
    trees: 0.48, treeRadius: 64, grass: 0.82, grassHeight: 1.22, clutter: 1.22,
  ...
  mata: {
    ...
    trees: 1.55, treeRadius: 80, grass: 0.40, grassHeight: 0.82, clutter: 1.38,
  ...
  clareira: {
    ...
    trees: 0.52, treeRadius: 68, grass: 1.48, grassHeight: 1.06, clutter: 1.12,
  ...
  cinema: {
    ...
    trees: 1.05, treeRadius: 78, grass: 1.16, grassHeight: 1.00, clutter: 1.22,
  ...
  rochoso: {
    ...
    trees: 0.32, treeRadius: 60, grass: 0.46, grassHeight: 0.68, clutter: 0.92,
